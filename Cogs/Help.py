...
class Help(commands.Cog):
	...
	async def fighthelp(self, ctx):
		...
		embed.add_field(name="focus", value="**makes the basic attack do 180% more damage and the secondary attack have a 25% chance to hit and only lasts for the next turn**")
		embed.add_field(name="end", value="**ends the fight**")
		await ctx.send(embed=embed)
