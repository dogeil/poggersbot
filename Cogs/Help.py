...
class Help(commands.Cog):
	...
	async def mischelp(self, ctx):
		...
		embed.add_field(name=".howmuchtimeleftuntil", value="checks how much time left until a certain date/time, SYNTAX: \"Day,Month,Year,Hour,Minute,\", fill in 0 for variables you dont want and ONLY USE NUMBERS")
