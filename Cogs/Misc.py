...
class Misc(commands.Cog):
	...
	@commands.command(help="Says what you enter")
	...
	@commands.command(help="Says what you enter and deletes your message")
	async def saydel(self, ctx, *, Text = None):
		if Text == None:
			await ctx.send("You need to give me some text")
		else:
			await ctx.send(Text)
