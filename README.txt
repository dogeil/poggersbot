if you want to run this code on your own bot you have to 
...
5) remove the lines "from keep_alive import keep_alive" and "keep_alive()" from the main.py file

6) delete the keep_alive.py file
